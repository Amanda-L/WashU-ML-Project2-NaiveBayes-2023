...
# # V is a feature vector that maps specific prefixes and suffixes to a unique vector of 0s and 1s dependent on the letters in those
# # Test name2features
# v = name2features("Charlie")
# print(v)